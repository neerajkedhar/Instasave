          ...
          child: Column(
            children: [
              ...
              ListTile(
                ...
                subtitle: Text("/storage/emulated/0/InstaSave"),
                onTap: () {},
              ),
              ListTile(
                title: Text('Invite a friend'),
                subtitle: Text("Invite your friends to use Instasave"),
                onTap: () {
                  sendAnalytics("Invite Your Friend is Clicked");
              ...
              ListTile(
                title: Text('Rate Us'),
                subtitle: Text(
                    "Like using Instasave to download Instagram Posts? Let us know by giving a 5 star rating"),
                onTap: () {
                  sendAnalytics("Rate us is Clicked");
                  _launchURL();
                },
              ),
              ListTile(
                ...
                onTap: () {
                  sendAnalytics("Report is clicked");
                  _launchURL();
                },
              ),
              ListTile(
  ...
  showAlertDialog(BuildContext scontext) {
    ...
    AlertDialog alert = AlertDialog(
      ...
      content: Container(
        ...
        child: SingleChildScrollView(
          child: Text(
              "- InstaSave is not affiliated with Instagram. its a tool for downloading \u0022Public\u0022 posts from Instagram.\n\n- We respect the copyright of the owners/creators. So please do not download any posts without owner's consent.\n\n- InstaSave is only for your personal study and research, so please do not use our service to download posts for any commercial use.\n\n- We(InstaSave / Kedhar Studios) are not responsible if you are using our services for any illegal activities "),
        ),
      ),
      actions: [
        okButton,
